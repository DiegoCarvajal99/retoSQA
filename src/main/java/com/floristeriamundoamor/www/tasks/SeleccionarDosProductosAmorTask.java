...
import static com.floristeriamundoamor.www.UI.PaginaInicialUI.BTN_AMOR;
import static net.serenitybdd.screenplay.Tasks.instrumented;
import static net.serenitybdd.screenplay.matchers.WebElementStateMatchers.isClickable;

public class SeleccionarDosProductosAmorTask implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                WaitUntil.the(BTN_AMOR, isClickable()).forNoMoreThan(30).seconds(),
                Click.on(BTN_AMOR),
    ...
    public static SeleccionarDosProductosAmorTask on(){
        return instrumented(SeleccionarDosProductosAmorTask.class);
    }
}
